...
const services = [
  { n: "01", name: "Potong Rambut", desc: "Klasik hingga butterfly, layer, bob", image: "service-potong.png", duration: "45–90 min" },
  { n: "02", name: "Hair Coloring", desc: "Full color, highlights, balayage, ombre", image: "service-coloring.png", duration: "2–3 jam" },
  { n: "03", name: "Hair Treatment", desc: "Creambath, hair mask, smoothing", image: "service-treatment.png", duration: "60–90 min" },
  { n: "04", name: "Styling Rambut", desc: "Blow, curling, updo untuk acara", image: "service-styling.png", duration: "30–60 min" },
  { n: "05", name: "Konsultasi Gaya", desc: "Gratis, sebelum treatment apapun", image: "service-konsultasi.png", duration: "15 min" },
  { n: "06", name: "Cuci & Blow", desc: "Shampoo premium, hasil rapi", image: "service-cuci.png", duration: "30–45 min" },
];
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 max-w-lg text-lg text-text-muted leading-relaxed anim-fade-up anim-delay-200">
                Potongan rambut terbaik di Yogyakarta dengan keramahan yang bikin kamu betah berlama-lama. Rating <strong className="text-pink-600">4.90/5</strong> dari <strong className="text-pink-600">3.840</strong> pelanggan.
              </p>
              ...
              <div className="mt-12 flex flex-wrap items-center gap-6 anim-fade-up anim-delay-500">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-bold text-ink">{BUSINESS.rating}/5</div>
                ...
                <div className="flex items-center gap-2">
                  <div className="relative h-9 w-9 rounded-full overflow-hidden ring-2 ring-pink-200/60 shrink-0">
                    <Image src="/assets/stylist-debby.png" alt="Mba Debby" fill className="object-cover" />
                  </div>
                  <div>
            ...
            <div className="relative anim-fade-scale anim-delay-200">
              ...
              <div className="absolute -bottom-6 -left-6 glass rounded-lg p-4 shadow-large anim-float">
                <div className="flex items-center gap-3">
                  <div className="relative h-12 w-12 rounded-lg overflow-hidden ring-2 ring-pink-200/60 shrink-0">
                    <Image src="/assets/service-coloring.png" alt="Rating bintang 5" fill className="object-cover" />
                  </div>
                  <div>
                    <div className="font-bold text-ink text-lg">{BUSINESS.rating}/5</div>
              ...
              <div className="absolute -top-6 -right-6 glass-pink rounded-lg p-4 shadow-large anim-float" style={{ animationDelay: "1.5s" }}>
                <div className="flex items-center gap-2">
                  <div className="relative h-10 w-10 rounded-full overflow-hidden ring-2 ring-pink-300/60 shrink-0">
                    <Image src="/assets/stylist-debby.png" alt="Mba Debby" fill className="object-cover" />
                  </div>
                  <div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-px mx-auto max-w-5xl relative z-10">
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            {[
              { image: "service-treatment.png", title: "Suasana hangat", desc: "Free drinks, snacks, dan musik Spotify — bukan sekadar potong rambut, tapi quality time." },
              { image: "service-konsultasi.png", title: "Harga transparan", desc: "Semua harga disampaikan di awal. Tidak ada kejutan saat bayar." },
              { image: "service-coloring.png", title: "96% bintang 5", desc: "3.701 dari 3.840 review bintang 5. Kami konsisten menjaga kualitas." },
            ].map((c, i) => (
              <div key={i} className={`card-soft text-center p-7 anim-fade-up anim-delay-${(i + 1) * 150}`}>
                <div className="relative h-20 w-20 mx-auto mb-4 rounded-xl overflow-hidden ring-2 ring-pink-200/60">
                  <Image src={`/assets/${c.image}`} alt={c.title} fill className="object-cover" />
                </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {BUSINESS.testimonials.slice(0, 3).map((t, i) => (
              <figure key={i} className={`card-soft anim-fade-up anim-delay-${(i + 1) * 150}`}>
                <div className="text-xs font-bold text-gold uppercase tracking-wider mb-3">5.0/5 rating</div>
        ...
        <div className="container-px mx-auto max-w-5xl">
          <div className="relative glass-pink rounded-xl p-12 sm:p-16 text-center anim-fade-up overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="relative h-20 w-20 mx-auto mb-6 rounded-full overflow-hidden ring-2 ring-pink-300/60 shadow-soft anim-bounce-soft">
                <Image src="/assets/hero.jpg" alt="Daisy Beauty Salon" fill className="object-cover" />
              </div>
